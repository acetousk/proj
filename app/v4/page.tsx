    ...
    return (
        <div className="relative min-h-screen">
            ...
            <div className="fixed left-4 top-1/2 -translate-y-1/2 flex flex-col items-center space-y-2 bg-black/20 backdrop-blur-sm pt-2 p-2 rounded-full">
                ...
                <Button variant="ghost" size="icon" asChild className="rounded-full">
                    <Link href="/v1" className="text-white hover:text-white hover:shadow-md hover:bg-white/10">
                        <Grid className="h-6 w-6"/>
                        <span className="sr-only">Grid</span>
                    </Link>
                </Button>
                <Button variant="ghost" size="icon" asChild className="rounded-full">
                    <Link href="/v2" className="text-white hover:text-white hover:shadow-md hover:bg-white/10">
                        <Zap className="h-6 w-6"/>
                        <span className="sr-only">Power</span>
                    </Link>
                </Button>
                <Button variant="ghost" size="icon" asChild className="rounded-full">
                    <Link href="/v3" className="text-white hover:text-white hover:shadow-md hover:bg-white/10">
                        <Wifi className="h-6 w-6"/>
                        <span className="sr-only">Wifi</span>
                    </Link>
                </Button>
                <Button variant="ghost" size="icon" asChild className="rounded-full">
                    <Link href="/v4" className="text-white hover:text-white hover:shadow-md hover:bg-white/10">
